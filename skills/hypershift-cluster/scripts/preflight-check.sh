...
# Colors + base log_info/success/warn come from lib-common.sh. This script keeps
# its own log_error that also increments the ERRORS counter (overrides the lib's).
