...
# Where to clone hypershift-automation. Prefer an existing checkout (env override,
# CI location, sibling, or $HOME); otherwise clone into $HOME/hypershift-automation.
HYPERSHIFT_AUTOMATION_DIR="$(find_hypershift_automation_dir)"
HYPERSHIFT_AUTOMATION_DIR="${HYPERSHIFT_AUTOMATION_DIR:-$HOME/hypershift-automation}"
